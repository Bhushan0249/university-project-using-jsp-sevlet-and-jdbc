...
<body>
	...
	<div class="navbar-top">
		...
		<!-- Navbar -->
		<ul>
			<li><a href="Cupdate.jsp"> <span class="icon-count">update</span>
					<i class="fa fa-envelope fa-2x"></i>
			</a></li>
			<li><a href="Cdelete.jsp"> <span class="icon-count">delete</span>
					<i class="fa fa-bell fa-2x"></i>
			</a></li>
			<li><a href="Clogout">logout <i
					class="fa fa-sign-out-alt fa-2x"></i>
			</a></li>
		</ul>
		<!-- End -->
	</div>
