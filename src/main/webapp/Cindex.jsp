...
<body class="bg-light" style="background-image: url(''); background-size: cover; background-repeat: no-repeat;">
			...
			<div class="col-md-6 offset-md-3">
				<div class="card card-sh">
					<div class="card-header">
						<h4 class="text-center"><i>College Login Page</i></h4>
					...
					<div class="card-body">
						<form action="Clogin" method="post">
							...
							<div class="text-center mt-2">
								...
								Don't have account <a href="Cregister.jsp"
